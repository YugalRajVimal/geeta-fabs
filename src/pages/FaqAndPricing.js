...
const FaqAndPricing = () => {
  ...
  return (
    <div className="-mt-[116px] h-full overflow-y-auto bg-gray-50">
      <div className="pt-[116px] px-6 md:px-10 flex flex-col lg:flex-row">
        <div className="w-full lg:w-1/2 pr-0 lg:pr-10">
          ...
          <div className="space-y-4">
            <div className="w-full shadow-lg rounded-lg">
              <div
                className="flex justify-between items-center border p-4 bg-[#ffc379] cursor-pointer"
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-blue-900 mt-10 mb-8">
            General FAQ's
          </h1>
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div key={index} className="w-full shadow-lg rounded-lg">
                <div
                  className="flex justify-between items-center border p-4 bg-[#ffc379] cursor-pointer"
        ...
        <div className="w-full lg:w-1/2 mt-10 lg:mt-0 flex flex-col justify-center ">
          <h1 className="text-4xl md:text-5xl italic text-blue-900 mt-10 mb-8">
            Ask Any Question
          </h1>
          <QuestionForm />
        </div>
