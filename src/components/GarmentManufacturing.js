      ...
      <div className="absolute hidden sm:block top-0 left-0 z-10 w-full sm:w-3/5 h-full px-4 md:px-10">
        ...
        >
          <div className="flex flex-col gap-2">
            <h1 className="text-3xl md:text-5xl italic text-[#7f152f]">
            ...
            <div className="flex flex-col gap-2 text-justify pl-4">
              ...
              <p>
                If you are a brand or retailer that cares about value for money,
                Geeta Fabs is a full-service clothing manufacturer based in
                Gurugram.
              </p>
            </div>
          </div>
        ...
        <div className="absolute top-[100%] sm:hidden left-0 z-10 w-full md:w-3/5 h-full px-4 md:px-10">
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <h5 className="text-lg pl-2 font-semibold">
              ...
              <div className="flex flex-col gap-2 text-justify pl-4">
                ...
                <p>
                  ...
                  money, Geeta Fabs is a full-service clothing manufacturer
                  based in Gurugram.
                </p>
              </div>
            </div>
